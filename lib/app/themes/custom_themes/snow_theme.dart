...
// Snow theme colors
final Color _primaryColor = Color(0xFF42A5F5);
final Color _secondaryColor = Color(0xFF9FA8DA);
final Color _backgroundColor = Color(0xFFF5F9FF);
final Color _surfaceColor = Colors.white;
final Color _textColor = Color(0xFF2C3E50);
final Color _accentColor = Color(0xFF1E88E5);

final ThemeData snowTheme = ThemeData(
  useMaterial3: true,
