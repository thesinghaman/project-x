...
// Sunset theme colors
final Color _primaryColor = Color(0xFFFF7043);
final Color _secondaryColor = Color(0xFFFFAB40);
final Color _backgroundColor = Color(0xFFFFF1E9);
final Color _surfaceColor = Colors.white;
final Color _textColor = Color(0xFF33291F);
final Color _accentColor = Color(0xFFFF5722);
